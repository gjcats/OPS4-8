...
real,    INTENT(IN)                            :: qbpri                      ! cross-wind integrated mass flux [g/s] of primary substance emitted from source
...
real,    INTENT(OUT)                           :: qsec                       ! cross-wind integrated mass flux of secondary substance [g/s]
...
real                                           :: hl                         ! 
real                                           :: gradsec                    ! 
real                                           :: qpri                       ! cross-wind integrated mass flux [g/s] of primary substance of depleted source
...
! SUBROUTINE ARGUMENTS - OUTPUT
real,    INTENT(OUT)                           :: qpri                       ! cross-wind integrated mass flux of primary substance of last time step (at receptor) [g/s]
real,    INTENT(OUT)                           :: qsec                       ! cross-wind integrated mass flux of secondary substance of last time step (at receptor) [g/s]
...
real                                           :: a1                         ! 
real                                           :: amolv                      ! ratio of molecular weights secondary : primary component
real                                           :: b                          ! 
real                                           :: dt                         ! length of time step [s]
real                                           :: dqsec                      ! amount of secondary component produced per time step
real                                           :: depl_pri_wetdep_chem       ! depletion factor for primary substance due to wet deposition and chemical conversion
real                                           :: depl_pri_drydep            ! depletion factor for primary substance due to dry deposition 
real                                           :: e2                         ! 
real                                           :: e3                         ! 
real                                           :: qpri_prev                  ! cross-wind integrated mass flux of primary substance in previous time step [g/s] 
real                                           :: qsec2                      ! alternative form for qsec 

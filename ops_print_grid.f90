...
real,    INTENT(IN)                            :: cseccor(nrrcp)             ! concentration of second secondary substance
real,    INTENT(IN)                            :: gemcseccor                 ! grid mean for second secondary concentration
...
real,    INTENT(IN)                            :: scale_sec_cor              ! scalefactor corrected sec. concentration

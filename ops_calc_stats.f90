...
real,    INTENT(IN)                            :: cseccor(nrrcp)             ! concentration of second secondary substance [ug/m3]
...
real,    INTENT(OUT)                           :: gemcseccor                 ! grid mean for second secondary concentration [ug/m3]
...
real                                           :: somcseccor                 ! sum of second secondary concentrations [ug/m3]
